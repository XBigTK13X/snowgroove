...
class PlayerActions {
    ...
    onTranscodeSeek = () => {
        this.onAddLog({ kind: 'snowgroove', message: `transcode triggered seek to ${playerState.manualSeekSeconds} seconds` })
    ...
    onVideoReady = () => {
        this.onAddLog({ kind: 'snowgroove', message: 'low level video player reports that it is ready to play' })
