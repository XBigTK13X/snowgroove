...
def test_anime_metadata():
    song = parse_file(
        'Anime/A Place Further Than the Universe/OP IN ED (2018)/001 - The Girls Are Alright! - 1ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_artist_title_dashes():
    song = parse_file(
        'Game/Smash Bros/Vol. 35 - Fatal Fury (2018)/001 - Haremar Faith Capoeira School - Song of the Fight (Believers Will Be Saved) - FATAL FURY - 8ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3"'
    )
...
def test_multidisc_track():
    song = parse_file(
        'Game/Nintendo Switch/The Legend of Zelda Breath of the Wild (2018)/D03T31 - Urbosa and the Divine Beast - 7ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
    assert song.disc == 3
...
def test_artist_metadata():
    song = parse_file(
        'Artist/Barenaked Ladies/Gordon (1992)/04 - Brian Wilson - 2ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_compilation_metadata():
    song = parse_file(
        'Compilation/Anime Hits (2019)/001 - Tori Kago (ED1) - Darling in the Franxx - 3ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_disney_metadata():
    song = parse_file(
        'Disney/Brave (2012)/001 - Touch The Sky - 4ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_game_metadata():
    song = parse_file(
        'Game/Wii U/Rayman Legends (2013)/007 - Score Recap - 5ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_game_song_id_collision():
    first = parse_file(
        'Game/SNES/Super Mario All-Stars (1993)/D02T001 - Title - Super Mario Bros. 2 - 9ec7c9cbb5c038a66f7802a3b9f6f222.adjusted.mp3'
    )
    second = parse_file(
...
def test_movie_metadata():
    song = parse_file(
        'Movie/La La Land (2016)/001 - Another Day of Sun - 6ec7c9cbb5c038a66f7802a3b9f6f220.adjusted.mp3'
    )
...
def test_messy_percent_encoding():
    song = parse_file(
        r'Anime/K-On/Image Songs - Main Cast Part 1 (2013.06)/008 - Mokujise Happy 100% - 709b6c5b53e298b4c0e92fe2b613d5cf.adjusted.mp3'
    )
...
def test_messy_hash_encoding():
    song = parse_file(
        'Anime/K-On/K-ON Commerical Breaks (2013.14)/025 - Subtitle Track #25 - 5b8f446128ea1b0e32b5fa6f37e03b88.adjusted.mp3'
    )
...
def test_no_top_level_category():
    song = parse_file(
        'Classical/Johann Sebastian Bach/Bradenburg Concertos (2013)/01 - Brandenburg Concerto No. 1 in F Major, BWV 1046 - I. Allegro - 2eae67b118c6190c6547e6c7c24e4c1e.adjusted.mp3'
    )
...
def test_v2_az_wrapper_folder():
    song = parse_file(
        'Game A-Z/C/Civilization V (2010)/D01T001 - America - Peace - Songs For The Morning Star - dd500993d0eca0f52e33496d8e4da71a.adjusted.mp3'
    )
...
def test_v2_subfolder_as_artist():
    song = parse_file(
        'Anime/Symphogear/Symphogear (2012)/001 - Synchrogazer - 18571a9b29f4632c8be2f3815a14d11b.adjusted.mp3'
    )
...
def test_v2_sub_kind_ignored_as_artist():
    song = parse_file(
        'Anime/Symphogear/Symphogear (2012)/Special/OST 1 (2012)/001 - Sora ni Hoshi Nagare, Namida wa Hoo wo Tsutau (FIRST LOVE SONG) - 6f34f2a42aba236dd92bc7762c76f2df.adjusted.mp3'
    )
    assert (
        song.title == 'Sora ni Hoshi Nagare, Namida wa Hoo wo Tsutau (FIRST LOVE SONG)'
    )
...
def test_v2_nested_album_split():
    song = parse_file(
        'Anime/Symphogear/Symphogear (2012)/Character Song 1 - Zwei Wing (2012)/001 - Gyakkou no Flugel - 4dc2ab66e1cb3dcccee8870e6b087058.adjusted.mp3'
    )
