...
if not os.environ.get("SNOWGROOVE_WEB_API_URL"):
...
log.info(f"snowgroove server v{config.server_version} [{config.server_build_dev_number}] built {config.server_build_date} now running.")