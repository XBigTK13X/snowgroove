...
class User(BaseModel):
    ...
    access_tags: orm.Mapped[List['Tag']] = orm.relationship(
        secondary='snowgroove_user_tag'
    )
    access_shelves: orm.Mapped[List['Shelf']] = orm.relationship(
        secondary='snowgroove_user_shelf'
    )
...
class ClientDeviceUser(BaseModel):
    ...
    snowgroove_user_id: orm.Mapped[int] = orm.mapped_column(
        sa.ForeignKey('snowgroove_user.id'), nullable=False
    )
    client_device_id: orm.Mapped[int] = orm.mapped_column(
        sa.ForeignKey('client_device.id'), nullable=False
    )
    ...
    music_session: orm.Mapped['MusicSession'] = orm.relationship(
        back_populates='client_device_user'
    )
...
class Tag(BaseModel):
    ...
    albums: orm.Mapped[List['Album']] = orm.relationship(
        secondary='album_tag', back_populates='tags'
    )
    artists: orm.Mapped[List['Artist']] = orm.relationship(
        secondary='artist_tag', back_populates='tags'
    )
    crates: orm.Mapped[List['Crate']] = orm.relationship(
        secondary='crate_tag', back_populates='tags'
    )
...
class ImageFile(BaseModel):
    ...
    crate_id: orm.Mapped[int] = orm.mapped_column(
...
class Crate(BaseModel):
    ...
    parent: orm.Mapped['Crate'] = orm.relationship(
        'Crate', remote_side='Crate.id', back_populates='children'
    )
    children: orm.Mapped[List['Crate']] = orm.relationship(
        'Crate', back_populates='parent'
    )
    albums: orm.Mapped[List['Album']] = orm.relationship(back_populates='crate')
    artists: orm.Mapped[List['Artist']] = orm.relationship(
        secondary='crate_artist', back_populates='crates'
    )
    audio_files: orm.Mapped[List['AudioFile']] = orm.relationship(
        back_populates='crate'
    )
    image_files: orm.Mapped[List['ImageFile']] = orm.relationship(
        back_populates='crate'
    )
    metadata_files: orm.Mapped[List['MetadataFile']] = orm.relationship(
        back_populates='crate'
    )
    tags: orm.Mapped[List['Tag']] = orm.relationship(
        secondary='crate_tag', back_populates='crates'
    )
...
class Artist(BaseModel):
    ...
    name = sa.Column(sa.Text)
    crates: orm.Mapped[List['Crate']] = orm.relationship(
        secondary='crate_artist', back_populates='artists'
    )
    tags: orm.Mapped[List['Tag']] = orm.relationship(
        secondary='artist_tag', back_populates='artists'
    )
...
class Album(BaseModel):
    ...
    tags: orm.Mapped[List['Tag']] = orm.relationship(
        secondary='album_tag', back_populates='albums'
    )
...
class MusicSession(BaseModel):
    ...
    remote_player: orm.Mapped['RemotePlayer'] = orm.relationship(
